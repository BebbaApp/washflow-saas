...
export const WashQueue = ({ orders, onUpdateStatus, onUpdateNotes, onApproveDiscount, onRejectDiscount }: WashQueueProps) => {
  ...
  return (
    <div className="space-y-6">
      {/* Tabs */}
      <div className="flex items-center gap-1 p-1 rounded-full bg-secondary border border-border overflow-x-auto sm:inline-flex">
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              className={`flex-none px-3 py-1.5 sm:px-4 rounded-full text-xs sm:text-sm font-medium transition-all whitespace-nowrap ${
                active
